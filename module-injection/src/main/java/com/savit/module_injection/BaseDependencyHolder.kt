...
abstract class DependencyHolderList<A : BaseFeatureAPI, D : BaseFeatureDependencies>(
    private val apis: List<A>
) : BaseDependencyHolder<D> {
    abstract val block: (BaseDependencyHolder<D>, List<A>) -> D
