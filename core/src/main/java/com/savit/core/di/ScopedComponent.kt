...
/**
 * Get the parent Activity component.
 */
@Suppress("UNCHECKED_CAST")
...
/**
 * Get the parent [Fragment] component.
 */
@Suppress("UNCHECKED_CAST")
fun <T> Fragment.parentFragmentScopedComponent(): T {
    val viewModels = ViewModelProvider(requireParentFragment())
    val componentHolder = viewModels.get(ScopedComponentHolder::class.java)
    return componentHolder.component as T
}
