...
class DashboardViewModel @Inject constructor(
    ...
    private val recordsDisposable = CompositeDisposable()
    private fun getRecords(account: AccountUiModel) {
        recordsDisposable.clear()
